            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row text-center justify-content-center align-items-center">
                        ...
                        <label for="">Metros disponibles:</label>
                        <input class="form form-control" type="text" id="metrosSu" disabled>
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-center align-items-center  text-center" style="min-height: 70vh;">
        <div class="col-10">
            <form action="/<?php echo APP_NAME; ?>/Venta/create" method="POST" class="border-form mb-4"
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="container cont-table">
                            <table class="table display table-hover text-center" id="table3">
                                <thead>
                                    <tr>
                                        <th class="ocultar-columna">cod</th>
                                        <th class="ocultar-columna">cod_cor</th>
                                        <th class="ocultar-columna">cod_su</th>
                                        <th>Nombre</th>
                                        <th>Color</th>
                                        <th>Calidad</th>
                                        <th>Marca</th>
                                        <th>Opciones</th>
                                        <th class="ocultar-columna">PRECIO REAL</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                    foreach ($datos as $row) {
                      ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['ROLLOS'] == 0 && $row['METROLLO'] == 0) { ?>
                        ...
                        <table class="table display table-hover text-center" id="table4">
                            <thead>
                                <tr>
                                    ...
                                    <th class="ocultar-columna">sub real</th>
                ...
                <input value="" name="" id="priceTotalReal" type="hidden"/>
                ...
                <div class="form-section" id="seccion4">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            ...
                            <input id="costo_c" class="form form-control" type="text" value="100" readonly>
                        </div>

                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="">Descuento: <b id="val-descuento">0</b> %</label>
                            <input id="descuento" class="form form-control" type="range" min="0" max="10" step="1"
                                value="0">
                            <input type="hidden" name="descuento" id="desc_input" value="">
                        </div>
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <label for="">Costo Final (Bs.):</label>
                            <input class="form form-control" type="number" id="total" name="total" readonly>
                        </div>
                    ...
                    <div class="row mt-3 justify-content-center align-items-center">
                        <div class="col-5 mr-3">
                            <button class="btn btn-primary mt-5 float-left" type="button" onclick="anteriorSeccion()"
                                type="button">
                                <i class="fas fa-arrow-left"> Anterior</i>
                            </button>
                        </div>
