...
<div class="container-fluid">
  ...
  <div class="row justify-content-center align-items-center  text-center" style="min-height: 70vh;">
    <div class="col-10" >
      <form action="/<?php echo APP_NAME; ?>/proveedor/create" method="POST" class="border-form">
        ...
        <div class="container-fluid">
          ...
          <div class="row mt-3 justify-content-center align-items-center">
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
              <div class="clearfix">
                <a href="/<?php echo APP_NAME.'/Proveedor'?>" class="btn btn-primary mt-5 float-left">Volver</a>
                <button type="submit" id="btnSave" class="btn btn-success mt-5 float-right">Guardar</button>
              </div>
            </div>
          </div>
        </div>
