...
<div class="container-fluid">
    ...
    <div class="row justify-content-center align-items-center  text-center" style="min-height: 70vh;">
        <div class="col-10">
            <form action="/<?php echo APP_NAME; ?>/Productos/save" method="POST" class="border-form" id="formTela">
                <input type="hidden" name="id" value="<?php echo $datos2['id'] ?>">
                <div class="container-fluid">
                    <div class="form-section active" id="seccion1">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                ...
                                <input type="text" class="form-control" id="nameTela" name="nombre" 
                                value="<?php echo $datos2['nombre'] ?>"
                                required>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <div class="clearfix">
                                    <a href="/<?php echo APP_NAME . '/Productos' ?>"
                                        class="btn btn-primary mt-5 float-left">Cancelar</a>
